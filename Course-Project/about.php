...
<html lang="en">
  ...
  <body>
    ...
    <div class="heading" style="background: url(../Course-Project/Media/Images/header-bg-1.png) no-repeat;">
      <h1>About us</h1>
    </div>
...
<section class="about">
  ...
  <div class="image">
     <img src="../Course-Project/Media/Images/about-img.jpg" alt="">
  </div>

  <div class="content">
     <h3>why choose us?</h3>
     <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
      Iure numquam nulla iusto corporis dolor commodi libero, vitae obcaecati optio rerum ab culpa nesciunt, 
      earum mollitia quasi ipsam non. Aliquid, iure.</p>
     <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. 
      Aliquid rerum, delectus voluptate aliquam quaerat iusto repellendus error nulla ab atque.</p>
   ...
   <div class="swiper reviews-slider">
      ...
      <div class="swiper-wrapper">
         ...
         <div class="swiper-slide slide">
            ...
            <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. 
               Minus facilis laudantium magnam saepe magni ullam possimus laborum voluptas, 
               veniam ipsum officiis quae doloribus minima ut quis. Molestiae qui distinctio possimus?</p>
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-1.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-2.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-3.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-4.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-5.png" alt="">
         </div>
         ...
         <div class="swiper-slide slide">
            ...
            <h3>john deo</h3>
            <span>traveler</span>
            <img src="../Course-Project/Media/Images/pic-6.png" alt="">
         </div>
